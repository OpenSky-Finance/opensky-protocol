...
makeSuite('PullRewardsIncentivesController - Claim rewards on behalf', (testEnv) => {
  ...
  it('Should claimRewardsOnBehalf revert if called claimer is not authorized', async () => {
    const { pullRewardsIncentivesController, user001:userWithRewards, user002:thirdClaimer, aDaiBaseMock, aaveToken } = testEnv;
  ...
  it('Should setClaimer pass if called by emission manager', async () => {
    const { pullRewardsIncentivesController, user001:userWithRewards, user002:thirdClaimer, rewardsVault, deployer } = testEnv;
  ...
  it('Should claimRewardsOnBehalf revert if user argument is ZERO_ADDRESS', async () => {
    const { pullRewardsIncentivesController, user001:userWithRewards, user002:thirdClaimer, aDaiBaseMock, rewardsVault, deployer } = testEnv;
