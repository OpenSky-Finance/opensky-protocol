...
contract Registry is AccessControlEnumerable, Allowlist, Blocklist, IRegistry {
    constructor() {
        //opensky: for openzeppelin compatibility, change from _grantRole to grantRole
     ...
     */
    function setIsAllowlistDisabled(bool disabled) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function setIsBlocklistDisabled(bool disabled) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @param operator Address of operator
     */
    function isBlocked(address operator) external view override(IRegistry, Blocklist) returns (bool) {
     ...
     * @param operator Address of operator
     */
    function isAllowed(address operator) external view override(IRegistry, Allowlist) returns (bool) {
     ...
     */
    function addAllowedContractAddress(address contractAddress) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @param contractAddress Address of allowed operator
     */
    function removeAllowedContractAddress(address contractAddress) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function addAllowedCodeHash(bytes32 codeHash) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @param codeHash Code hash of allowed contract
     */
    function removeAllowedCodeHash(bytes32 codeHash) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function addBlockedContractAddress(address contractAddress) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @param contractAddress Address of blocked operator
     */
    function removeBlockedContractAddress(address contractAddress) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     */
    function addBlockedCodeHash(bytes32 codeHash) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * @param codeHash Code hash of blocked contract
     */
    function removeBlockedCodeHash(bytes32 codeHash) external virtual onlyRole(DEFAULT_ADMIN_ROLE) {
