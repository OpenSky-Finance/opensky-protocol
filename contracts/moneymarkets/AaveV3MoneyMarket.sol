...
contract AaveV3MoneyMarket is IOpenSkyMoneyMarket {
    ...
    constructor(IPool aave_) public {
        aave = aave_;
    ...
    function depositCall(address asset, uint256 amount) external override requireDelegateCall {
        require(amount > 0, "MONEY_MARKET_DEPOSIT_AMOUNT_ALLOWED");
    ...
    function getBalance(address asset, address account) public view override returns (uint256) {
        address aToken = getMoneyMarketToken(asset);
